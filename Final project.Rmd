...
We will employ side-by-side box plots to represent the age distribution based on different
cancer stages, providing insights into age variations across stages.
```{r}
library(ggplot2)
brca <- read.csv("BRCA.csv")
cancer_data_cleaned <- na.omit(brca, cols = c("Age", "Tumour_Stage"))

pink_colors <- c("#FFC0CB", "#FFB6C1", "#FF69B4", "#FF1493", "#DB7093")
...
2.
Aiming to understand histology patterns, we will construct absolute and relative frequency
tables to showcase the number of individuals with specific histological characteristics.
```{r}
library(dplyr)
...
3.
Utilizing scatter plots, we will explore correlations between different proteins, offering
insights into potential relationships that may contribute to the understanding of breast
cancer.
```{r}
library(ggplot2)
```
...
4.
Histograms will be employed to visualize the distribution of patient ages, providing a
comprehensive overview with an appropriate number of bins.
```{r}
N <- nrow(brca_clean)
num_bins <- ceiling(1 + log2(N))
num_bins
...
```{r out.width='50%', fig.align='center'}
qq1 <- ggplot(stage1, aes(sample=Protein1)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 1 in Tumour satge I")
qq1
qq2 <- ggplot(stage1, aes(sample=Protein2)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 2 in Tumour satge I")
qq2
qq3 <- ggplot(stage1, aes(sample=Protein3)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 3 in Tumour satge I")
qq3
qq4 <- ggplot(stage1, aes(sample=Protein4)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 4 in Tumour satge I")
qq4
```
...
```{r out.width='50%', fig.align='center'}
qq5 <- ggplot(stage2, aes(sample=Protein1)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 1 in Tumour stage II")
qq5
qq6 <- ggplot(stage2, aes(sample=Protein2)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 2 in Tumour stage II")
qq6
qq7 <- ggplot(stage2, aes(sample=Protein3)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 3 in Tumour stage II")
qq7
qq8 <- ggplot(stage2, aes(sample=Protein4)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 4 in Tumour stage II")
qq8
```
...
```{r out.width='50%', fig.align='center'}
qq9 <- ggplot(stage3, aes(sample=Protein1)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 1 in Tumour stage III")
qq9
qq10 <- ggplot(stage3, aes(sample=Protein2)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 2 in Tumour stage III")
qq10
qq11 <- ggplot(stage3, aes(sample=Protein3)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 3 in Tumour stage III")
qq11
qq12 <- ggplot(stage3, aes(sample=Protein4)) + stat_qq() + stat_qq_line() + labs(x="Theoretical Quantile", y="Actual Data", title="Quantile-Quantile plot for Protein 4 in Tumour stage III")
qq12
```
